...
public class DerivationToolBar extends JToolBar
{
	 ...
	 * 
	 */
	public DerivationToolBar(final ExpLineEditor editor, int orientation)
	{
		super(orientation);
		...
		final mxGraphView view = editor.getCurrentGraphComponent().getGraph()
				.getView();
