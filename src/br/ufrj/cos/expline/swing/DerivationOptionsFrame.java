...
public class DerivationOptionsFrame extends JDialog
{
	 ...
	 * 
	 */
	public DerivationOptionsFrame(Frame owner, ExpLineGraphComponent expLineGraphComponent)
	{
		super(owner);
		...
		JLabel titleLabel = new JLabel("Derivation Options Selection");
	...
	void editRule(){
		...
		if(!ruleJList.isSelectionEmpty()){
			...
			EditRuleFrame frame = new EditRuleFrame((Dialog)DerivationOptionsFrame.this, expLineGraphComponent, rule);
			frame.setModal(true);
