...
public class EditorRuleFrame extends JDialog
{
	 ...
	 * 
	 */
	public EditorRuleFrame(Dialog owner, mxGraphComponent graphComponent)
	{
		super(owner);
...
//		panel2.add(titleLabel, BorderLayout.CENTER);
	    ...
	    final JPanel conditionPanel1 = new ConditionPanel();
