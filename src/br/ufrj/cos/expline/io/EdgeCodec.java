 ...
 */
public class EdgeCodec extends mxObjectCodec
{
	...
	public EdgeCodec()
	{
		this(new Edge(), null, new String[] { "parent", "source", "target" },
				null);
	}
	 ...
	 */
	public EdgeCodec(Object template)
	{
	 ...
	 */
	public EdgeCodec(Object template, String[] exclude, String[] idrefs,
	...
	public Node afterEncode(mxCodec enc, Object obj, Node node)
	{
		if (obj instanceof Edge)
		{
			...
			if (edge.getValue() instanceof Node)
			{
				...
				node = enc.getDocument().importNode((Node) edge.getValue(),
						true);
	...
	public Node beforeDecode(mxCodec dec, Node node, Object obj)
	{
		...
		if (obj instanceof Edge)
		{
			...
			{
				edge.setId(((Element) node).getAttribute("id"));
			}
