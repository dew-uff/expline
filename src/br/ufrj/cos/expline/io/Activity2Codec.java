 ...
 */
public class Activity2Codec extends mxObjectCodec
{

	/**
	 * Constructs a new cell codec.
	 */
	public Activity2Codec()
	{
		this(new Activity(), new String[] { "type", "style", "parent", "geometry", "vertex", "selected" }, new String[] { "parent", "source", "target" },
				null);
	}
	 ...
	 */
	public Activity2Codec(Object template)
	{
	 ...
	 */
	public Activity2Codec(Object template, String[] exclude, String[] idrefs,
